...
```json
{
  ...
  "unmappedFRs": [
    { "id": "FR-003", "type": "impl|test|uiux|acceptance_predicate", "reason": "구현 파일 없음" }
  ],
...
| **WARN** | Medium/Low FR 누락 or uiux FR WARN **or Level 1-2만 확인 (Wired 미확인)** or **acceptance_predicate 미작성 FR 1개+** | Lead에게 보고 |
