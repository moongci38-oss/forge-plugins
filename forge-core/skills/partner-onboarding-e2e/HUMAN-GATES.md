...
# partner-onboarding-e2e — Human Gates & Budget
...
| G3 | 비용 초과 | 외부 API 비용 임계 초과 전 | 예산 소유자 |
...
1. 루프가 `$HOME/mywsl_workspace/starbeginz-origin/loops/partner-onboarding-e2e/STATE.md`에 gate-request 기록
2. Human이 명시적 승인
3. 루프가 승인 확인 후 계속
...
| call-budget | 100 | hook WARN → Human 판단 |
| **wall-clock 상한** | 2h | 즉시 중단 |
