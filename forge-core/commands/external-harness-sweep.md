...
결과를 다음 경로에 저장:
- 채택 매트릭스: `${FORGE_OUTPUTS:-$HOME/forge-outputs}/docs/reviews/final/<name>-sweep.json`
- 리포트: `${FORGE_OUTPUTS:-$HOME/forge-outputs}/11-platform/reports/<name>-forge-analysis-<YYYY-MM-DD>.md`
