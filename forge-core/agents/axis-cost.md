...
> **출력 언어: 한국어만**(코드 식별자·파일 경로 제외). R-3, 2026-08-16 실측: 이 축이 **haiku 이던 시절**
> findings 제목·근거에 일본어 129자를 혼입했다. **2026-08-25 에 opus 로 상향**했다(그 재검토 조항의 이행 —
> 나머지 axis 4축과도 일관). 재발하면 tier 가 아니라 프롬프트를 의심할 것.
