...
export const meta = {
  name: 'visual-loop',
  description: '디자인 시안 vs 구현 시각 비교 — 3 viewport Codex(sol) Vision parallel() 동시 + 수렴 루프',
  phases: [
    { title: 'Compare', detail: '3 viewport(mobile/tablet/desktop) Codex(sol) Vision 병렬 비교' },
