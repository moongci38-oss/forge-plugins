---
name: api-e2e
description: "REST API HTTP 레벨 E2E 자동 테스트. Spec/OpenAPI/Swagger 읽어 happy path/인증실패/잘못된입력/경계값 케이스 생성+curl 실행, 스키마 드리프트 감지. /qa 서버/API 감지 시 자동, 직접호출 /api-e2e <spec-path>."
context: fork
model: sonnet
---
