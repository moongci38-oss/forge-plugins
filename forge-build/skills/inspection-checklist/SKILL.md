...
description: "Forge Dev P5 모든 Check(P5.5, P5.6, P5.7, P5.9) + P6 QA를 통합한 최종 검수 체크리스트를 생성한다. P5/P6 모든 Check 완료 후 PR 생성 직전 또는 릴리스 전 최종 점검 시 실행. 빌드/테스트, Spec 추적성, UI 품질, 코드 리뷰, 보안 5개 영역을 종합 판정한다."
context: fork
...
| 보안 | P6 QA(T6) | `/forge-check-security` 재실행 |
