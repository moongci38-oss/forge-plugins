...
if (l3 && typeof l3.score === 'number' && l3.score < 6.0) {
  finalVerdict = 'FAIL'
  log(`[L3] 6-Pillar ${l3.score.toFixed(1)} < 6.0 → ${verdict} 에서 FAIL 로 격상`)
} else if (l3) {
...
return {
  ...
  l3: l3 ? { score: l3.score, verdict: l3.verdict, pillars: l3.pillars ?? null, findings: l3.findings || [] } : null,
