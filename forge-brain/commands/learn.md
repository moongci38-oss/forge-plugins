...
3. `~/.claude/scripts/learnings.sh add` 실행
4. 시크릿·민감정보 포함 시 저장 거부 (exit 2)

### search
1. `~/.claude/scripts/learnings.sh search <keyword>` 실행
...
- 스킬 SKILL.md: `~/forge/.claude/skills/learn/SKILL.md`
- learnings 헬퍼: `~/.claude/scripts/learnings.sh`
- GC 스크립트: `~/forge/shared/scripts/learn-gc.sh`
